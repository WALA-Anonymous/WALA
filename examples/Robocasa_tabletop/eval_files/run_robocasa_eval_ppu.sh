...
ROBOCASA_PYTHON="${ROBOCASA_PYTHON:-${HOME}/miniconda3/envs/RoboCasa/bin/python}"
CKPT_DEFAULT="${CKPT_DEFAULT:-${WALA_ROOT}/results/Checkpoints/wala_wan_robocasa/checkpoints/best.pt}"
...
export PYTHONPATH="${WALA_ROOT}:${ROBOSUITE_PATH:-${WALA_ROOT}/third_party/robosuite}:${ROBOCASA_PATH:-${WALA_ROOT}/third_party/robocasa-gr1-tabletop-tasks}:${PYTHONPATH:-}"
